...
rappresenta la connessione con il DB. Se non ci riesce non restituisce nulla
    ...
    Ovviamente deve esitere un DB "corsophp" sul server "localhost", deve esistere un utente di nome "utentecorsophp" con password "fidia2018" (quando mi impegno riesco a creare password difficilissime)
...
$link = mysqli_connect("localhost", "utentecorsophp", "fidia2018", "corsophp");
